		...
		tabPanel(
			...
			fluidPage(
				div(
					...
					hr(),
					HTML('<h3 class="text-heading"> <i class="fa fa-quote-right"></i> Citation</h3>'),
					p(),
				   "To cite BFAST Explorer in publications, please use",
					pre('Alexandre Almeida, Nathalia Menini, Jan Verbesselt, Ricardo Torres (2018). BFAST Explorer: An Effective Tool for Time Series Analysis. In: 2018 IEEE International Geoscience and Remote Sensing Symposium (IGARSS). 22-27 July 2018. Valencia, Spain. DOI: 10.1109/IGARSS.2018.8517877.'),
					"or, alternatively, the corresponding BibTeX entry described",
					a("here", href = "https://github.com/almeidaxan/bfast-explorer#citation", target = "_blank"),
					hr(),
