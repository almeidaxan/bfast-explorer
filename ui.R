			...
			fluidPage(
				div(
					...
					hr(),
						...
						p(),
						div("MSc. Alexandre Esteves Almeida", a(icon("user", lib = "font-awesome"), href = "https://buscatextual.cnpq.br/buscatextual/visualizacv.do?id=K4672382A6", target = "_blank"), a(icon("envelope", lib = "font-awesome"), href = "mailto:almeida.xan@gmail.com")),
